...
public class CallbackUndoAction : BaseUndoAction
{
    ...
    public static CallbackUndoAction Create(DesignWidget Widget, Action<bool> Callback, bool RefreshParameters, List<BaseUndoAction>? OtherActions = null)
    {
    ...
    public static void Register(DesignWidget Widget, Action<bool> Callback, bool RefreshParameters, List<BaseUndoAction>? OtherActions = null)
    {
